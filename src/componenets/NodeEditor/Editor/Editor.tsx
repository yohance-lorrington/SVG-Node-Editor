...
// class NodeEditor extends React.Component<{}, Staet> {
//     svg: any;
//     visible: boolean;
//     ctxMenu: any;
//     ui: any;
...
//     }
//     componentDidMount(){
//         d3Zoom.bind(this, true)();
//         this.svg.addEventListener('contextmenu', this.contextmenu.bind(this));
...
//     }
//     setList(nice){
//         let joined = this.state.nodeList.concat(nice);
//         this.setState({nodeList: joined})
//     }
//     render(){
//         return (
//             <NodeProvider value={this.state}>
//             <EditorBG>
//                 <svg id="editor"  ref={svg => this.svg = svg} width="100%" height="100%" >
//                     <g width="100%" height="100%" ref={ui => this.ui = ui}>
//                         <g width="100%" height="100%" id="connections"></g>
